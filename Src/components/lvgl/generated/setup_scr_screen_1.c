...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_color(ui->screen_1, lv_color_hex(0x1edb2f), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_1_btn_1, 888, 468);
    ...
    lv_obj_set_style_bg_color(ui->screen_1_btn_1, lv_color_hex(0xdb7e1e), LV_PART_MAIN|LV_STATE_DEFAULT);
