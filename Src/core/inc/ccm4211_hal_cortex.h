/**
 * @file ccm4211_hal_cortex.h
 * @author ccore
 * @brief cc4211 hal cortex header file
 * @version 0.1
 * @date 2025-03-03
 *
...
#ifndef __CCM4211_HAL_CORTEX_H
#define __CCM4211_HAL_CORTEX_H
...
/* Exported macros------------------------------------------------*/
/** @addtogroup module_name Exported Macros
 * @{
 */
#if (__MPU_PRESENT == 1)
...
/* Exported types ------------------------------------------------*/
/** @addtogroup module_name Exported Types
 * @{
 */
#if (__MPU_PRESENT == 1)
...
#define IS_MPU_SUB_REGION_DISABLE(SUBREGION) ((SUBREGION) < (uint16_t)0x00FFU)
    ...
    /* Exported variables --------------------------------------------*/
    /** @addtogroup module_name Exported Variables
     * @{
     */
    ...
    /* Exported functions --------------------------------------------*/
    /** @addtogroup module_name Exported Functions
     * @{
     */
