...
void BoardI2CInit(reg_i2c_t *pi2c)
{
    I2C_Handle.Instance = pi2c;
    I2C_Handle.Init.Mode = I2C_MODE_MASTER;
    I2C_Handle.Init.AddBits = I2C_SLAVE_ADD_7BITS;
    I2C_Handle.Init.Add = 0x00;
    I2C_Handle.Init.HighSpeed = DISABLE;
    I2C_Handle.Init.ClockMode = I2C_CLOCK_MODE_NORMAL;
    I2C_Handle.Init.Prescaler = 0x00;
...
#else
    WM8978_Write_Reg(36, (7 << 0));
    WM8978_Write_Reg(37, (0x86C226 >> 18) & 0x3f);
    WM8978_Write_Reg(38, (0x86C226 >> 9) & 0x1ff);
    WM8978_Write_Reg(39, (0x86C226 >> 0) & 0x1ff);
    WM8978_Write_Reg(6, (1 << 0) | (2 << 2) | (2 << 5) | (1 << 8));
#endif
...
{
    uint8_t I2CXferBuf[2];

    I2CXferBuf[0] = (reg << 1) | ((val >> 8) & 0X01);
    I2CXferBuf[1] = (val & 0XFF);

    // I2c_writedata1((WM8978_ADDR<<1)|0, (reg<<1)|((val>>8)&0X01),(val&0XFF) );
    hal_i2c_mastertransmit(&I2C_Handle, (WM8978_ADDR << 1) | 0, I2CXferBuf, 2, 0);
